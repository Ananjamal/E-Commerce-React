...
const Cart = () => {
  ...
  const subtotal = cartItems.reduce((sum, item) => sum + calculateSubtotal(item.price, item.quantity), 0);
  const shipping = 0;
    ...
    },
    {
      ...
      render: (quantity, record) => (
        <Input 
          ...
          value={quantity}
          min={1}
          onChange={(e) => handleQuantityChange(record.key, parseInt(e.target.value) || 1)}
      ...
      <div className="cart-page-wrapper">
        <div className="cart-content-container">
          ...
          <Row justify="space-between" className="cart-actions-row">
            <Button className="return-shop-btn">
              Return To Shop
            </Button>
            ...
            <Col xs={24} md={12} className="cart-total-section">
              <div className="cart-total-card">
                <div className="cart-total-header">
                  <Title level={4} className="cart-total-title">Cart Total</Title>
                </div>
