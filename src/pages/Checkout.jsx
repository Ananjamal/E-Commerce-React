      ...
      <div className="checkout-page-wrapper">
        <div className="checkout-content-container">
          ...
          <Text className="checkout-breadcrumb">
            Account / My Account / Product / View Cart / <span className="current-page">Checkout</span>
          </Text>
          ...
          >
            <Row gutter={40}>
              {/* --- Left Column: Billing Details (Input style is the key change here) --- */}
              <Col xs={24} lg={12} className="billing-details-col">
                
                {/* Form Items */}
                <Form.Item name="firstName" className="checkout-form-item">
                  <Input placeholder="First Name*" className="checkout-input" />
                </Form.Item>

                <Form.Item name="companyName" className="checkout-form-item">
                  <Input placeholder="Company Name" className="checkout-input" />
                </Form.Item>

                <Form.Item name="streetAddress" className="checkout-form-item">
                  <Input placeholder="Street Address*" className="checkout-input" />
                </Form.Item>

                <Form.Item name="apartment" className="checkout-form-item">
                  <Input placeholder="Apartment, floor, etc. (optional)" className="checkout-input" />
                </Form.Item>
                
                <Form.Item name="city" className="checkout-form-item">
                  <Input placeholder="Town/City*" className="checkout-input" />
                </Form.Item>

                <Form.Item name="phoneNumber" className="checkout-form-item">
                  <Input placeholder="Phone Number*" className="checkout-input" />
                </Form.Item>

                <Form.Item name="emailAddress" className="checkout-form-item">
                  <Input placeholder="Email Address*" className="checkout-input" />
                </Form.Item>

                {/* Checkbox */}
                <Form.Item name="saveInfo" valuePropName="checked" className="checkout-checkbox-item">
              ...
              <Col xs={24} lg={12} className="order-summary-col">
                <div className="order-summary-box">
                  ...
                  <div className="coupon-and-order-btn">
                    ...
                    <Button htmlType="submit" className="place-order-btn">
                      Place Order
                    </Button>
                  </div>
                </div>
